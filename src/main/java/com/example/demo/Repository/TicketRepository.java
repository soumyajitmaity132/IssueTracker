...
@Query("SELECT t.status, COUNT(t) FROM Ticket t WHERE t.department = :department GROUP BY t.status")
List<Object[]> getTicketCountByStatusAndDepartment(@Param("department") String department);
